	...
	theme: {
		...
		extend: {
			colors: {
				...
				'chat-message-assistant': 'hsl(var(--chat-message-assistant))',
				'chat-message-user-text': 'hsl(var(--chat-message-user-text))',
				'chat-message-assistant-text': 'hsl(var(--chat-message-assistant-text))',
				secondary: {
